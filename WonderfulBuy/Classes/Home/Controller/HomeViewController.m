...
//  WonderfulBuy
//
//  Created by Weiwei Jiang on 15/3/8.
...
{
    Region *region = notification.userInfo[MTSelectRegion];
...
- (void)map
{
    NavigationController *nav = [[NavigationController alloc] initWithRootViewController:[[MapViewController alloc] init]];
    [self presentViewController:nav animated:YES completion:nil];
}
